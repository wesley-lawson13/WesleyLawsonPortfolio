...
const projects = [
  {
    ...
    title: "Lembas Links",
    description:
      "A production-grade URL shortener in Go that turns Lord of the Rings quotes into memorable short links via an NLP pipeline (spaCy + Claude API), with Redis caching, API key auth, and async click analytics.",
